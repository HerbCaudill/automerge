...
describe('Automerge.Backend', () => {
  describe('incremental diffs', () => {
    it('should assign to a key in a map', () => {
        ...
        ops: [
          {
            ...
            key: 'bird',
            value: 'magpie',
            pred: [], // empty because not overwriting a property
          },
        ],
      }

      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyChanges(v0, [encodeChange(change1)])
      ...
      assert.deepStrictEqual(patch1, {
        ...
        diffs: {
          ...
          props: {
            bird: {
              [`1@${actor}`]: { type: 'value', value: 'magpie' },
            },
          },
        },
      })
    ...
    it('should increment a key in a map', () => {
      ...
      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyChanges(v0, [encodeChange(change1)])
      const [v2, patch2] = Backend.applyChanges(v1, [encodeChange(change2)])
      ...
      assert.deepStrictEqual(patch2, {
        ...
        diffs: {
          ...
          props: {
            counter: {
              [`1@${actor}`]: { type: 'value', value: 3, datatype: 'counter' },
            },
          },
        },
      })
    ...
    it('should make a conflict on assignment to the same key', () => {
      const change1 = {
        ...
        time: 0,
        deps: [],
        ops: [{ action: 'set', obj: '_root', key: 'bird', value: 'magpie', pred: [] }],
      }
      const change2 = {
        actor: '222222',
        seq: 1,
        ...
        time: 0,
        deps: [hash(change1)],
        ops: [{ action: 'set', obj: '_root', key: 'bird', value: 'blackbird', pred: [] }],
      }
      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyChanges(v0, [encodeChange(change1)])
      const [v2, patch2] = Backend.applyChanges(v1, [encodeChange(change2)])
    ...
    it('should delete a key from a map', () => {
      ...
      const change2 = {
        ...
        time: 0,
        deps: [hash(change1)],
        ops: [{ action: 'del', obj: '_root', key: 'bird', pred: [`1@${actor}`] }],
      }
      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyChanges(v0, [encodeChange(change1)])
      const [v2, patch2] = Backend.applyChanges(v1, [encodeChange(change2)])
          ...
          props: {
            birds: {
              [`1@${actor}`]: {
                objectId: `1@${actor}`,
                type: 'map',
                props: { wrens: { [`2@${actor}`]: { type: 'value', value: 3 } } },
              },
            },
          },
        },
    ...
    it('should assign to keys in nested maps', () => {
      ...
      const change2 = {
        ...
        time: 0,
        deps: [hash(change1)],
        ops: [{ action: 'set', obj: `1@${actor}`, key: 'sparrows', value: 15, pred: [] }],
      }
      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyChanges(v0, [encodeChange(change1)])
      const [v2, patch2] = Backend.applyChanges(v1, [encodeChange(change2)])
          ...
          props: {
            birds: {
              [`1@${actor}`]: {
                objectId: `1@${actor}`,
                type: 'map',
                props: { sparrows: { [`3@${actor}`]: { type: 'value', value: 15 } } },
              },
            },
          },
        },
    ...
    it('should handle conflicts on nested maps', () => {
      ...
      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyChanges(v0, [change1, change2, change3].map(encodeChange))
      assert.deepStrictEqual(patch1, {
    ...
    it('should handle updates inside conflicted map keys', () => {
      ...
      const change3 = {
        ...
        startOp: 3,
        time: 0,
        deps: [hash(change1), hash(change2)].sort(),
        ops: [{ action: 'set', obj: `1@${actor2}`, key: 'sparrows', value: 17, pred: [`2@${actor2}`] }],
      }
      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyChanges(v0, [encodeChange(change1), encodeChange(change2)])
      const [v2, patch2] = Backend.applyChanges(v1, [encodeChange(change3)])
      assert.deepStrictEqual(patch2, {
        clock: { [actor1]: 2, [actor2]: 1 },
        deps: [hash(change3)],
        maxOp: 3,
    ...
    it('should apply updates inside lists', () => {
      ...
      const change2 = {
        ...
        time: 0,
        deps: [hash(change1)],
        ops: [{ action: 'set', obj: `1@${actor}`, elemId: `2@${actor}`, value: 'greenfinch', pred: [`2@${actor}`] }],
      }
      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyChanges(v0, [encodeChange(change1)])
      const [v2, patch2] = Backend.applyChanges(v1, [encodeChange(change2)])
    ...
    it('should apply updates inside conflicted list elements', () => {
      ...
      const change4 = {
        ...
        time: 0,
        deps: [hash(change2), hash(change3)].sort(),
        ops: [{ action: 'set', obj: `3@${actor1}`, key: 'done', value: true, pred: [`5@${actor1}`] }],
      }
      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyChanges(v0, [change1, change2, change3].map(encodeChange))
      const [v2, patch2] = Backend.applyChanges(v1, [encodeChange(change4)])
      assert.deepStrictEqual(patch2, {
        clock: { [actor1]: 3, [actor2]: 1 },
        deps: [hash(change4)],
        maxOp: 6,
        pendingChanges: 0,
        diffs: {
    ...
    it('should delete list elements', () => {
      ...
      const change2 = {
        ...
        time: 0,
        deps: [hash(change1)],
        ops: [{ action: 'del', obj: `1@${actor}`, elemId: `2@${actor}`, pred: [`2@${actor}`] }],
      }
      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyChanges(v0, [encodeChange(change1)])
      const [v2, patch2] = Backend.applyChanges(v1, [encodeChange(change2)])
    ...
    it('should handle list element insertion and deletion in the same change', () => {
      ...
      const change1 = {
        ...
        time: 0,
        deps: [],
        ops: [{ action: 'makeList', obj: '_root', key: 'birds', pred: [] }],
      }
      const change2 = {
        actor,
        seq: 2,
    ...
    it('should handle changes within conflicted objects', () => {
      ...
      const change1 = {
        ...
        time: 0,
        deps: [],
        ops: [{ action: 'makeList', obj: '_root', key: 'conflict', pred: [] }],
      }
      ...
      const change2 = {
        ...
        time: 0,
        deps: [],
        ops: [{ action: 'makeMap', obj: '_root', key: 'conflict', pred: [] }],
      }
      ...
      const change3 = {
        ...
        time: 0,
        deps: [hash(change2)],
        ops: [{ action: 'set', obj: `1@${actor2}`, key: 'sparrows', value: 12, pred: [] }],
      }

      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyChanges(v0, [encodeChange(change1)])
      const [v2, patch2] = Backend.applyChanges(v1, [encodeChange(change2)])
      const [v3, patch3] = Backend.applyChanges(v2, [encodeChange(change3)])
          ...
          props: {
            conflict: {
              ...
              [`1@${actor2}`]: {
                objectId: `1@${actor2}`,
                type: 'map',
                props: { sparrows: { [`2@${actor2}`]: { type: 'value', value: 12 } } },
              },
            },
          },
        },
    ...
    it('should support Date objects at the root', () => {
      ...
      const actor = uuid(),
        change = {
          ...
          time: 0,
          deps: [],
          ops: [{ action: 'set', obj: '_root', key: 'now', value: now.getTime(), datatype: 'timestamp', pred: [] }],
        }
      const v0 = Backend.init()
      const [v1, patch] = Backend.applyChanges(v0, [encodeChange(change)])
    ...
    it('should handle updates to an object that has been deleted', () => {
      ...
      const change2 = {
        ...
        time: 0,
        deps: [hash(change1)],
        ops: [{ action: 'del', obj: '_root', key: 'birds', pred: [`1@${actor1}`] }],
      }
      const change3 = {
        actor: actor1,
        seq: 2,
        ...
        time: 0,
        deps: [hash(change1)],
        ops: [{ action: 'set', obj: `1@${actor1}`, key: 'blackbirds', value: 2, pred: [] }],
      }
      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyChanges(v0, [encodeChange(change1)])
      const [v2, patch2] = Backend.applyChanges(v1, [encodeChange(change2)])
          ...
          props: {
            todos: {
              [`1@${actor}`]: {
                objectId: `1@${actor}`,
                type: 'list',
                edits: [{ action: 'multi-insert', index: 0, elemId: `2@${actor}`, values: [1, 2, 3, 4, 5] }],
              },
            },
          },
        },
    ...
    it('should support deleting multiple elements in one op', () => {
      ...
      const change2 = {
        ...
        time: 0,
        deps: [hash(change1)],
        ops: [{ action: 'del', obj: `1@${actor}`, elemId: `3@${actor}`, multiOp: 3, pred: [`3@${actor}`] }],
      }
      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyChanges(v0, [encodeChange(change1)])
      const [v2, patch2] = Backend.applyChanges(v1, [encodeChange(change2)])
          ...
          props: {
            todos: {
              [`1@${actor}`]: {
                objectId: `1@${actor}`,
                type: 'list',
                edits: [{ action: 'remove', index: 1, count: 3 }],
              },
            },
          },
        },
  ...
  describe('applyLocalChange()', () => {
    it('should apply change requests', () => {
      ...
      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyLocalChange(v0, change1)
      const changes01 = Backend.getAllChanges(v1).map(decodeChange)
      assert.deepStrictEqual(patch1, {
        actor: '111111',
        seq: 1,
        clock: { 111111: 1 },
      ...
      assert.deepStrictEqual(changes01, [
        {
          ...
          message: '',
          deps: [],
          ops: [{ action: 'set', obj: '_root', key: 'bird', insert: false, value: 'magpie', pred: [] }],
        },
      ])
    })
    ...
    it('should throw an exception on duplicate requests', () => {
      ...
      const change2 = {
        ...
        startOp: 2,
        deps: [],
        ops: [{ action: 'set', obj: '_root', key: 'bird', value: 'jay', pred: [] }],
      }
      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyLocalChange(v0, change1)
      const [v2, patch2] = Backend.applyLocalChange(v1, change2)
      assert.throws(() => Backend.applyLocalChange(v2, change1), /Change request has already been applied/)
      assert.throws(() => Backend.applyLocalChange(v2, change2), /Change request has already been applied/)
    })
    ...
    it('should handle frontend and backend changes happening concurrently', () => {
      ...
      const local2 = {
        ...
        startOp: 2,
        deps: [],
        ops: [{ action: 'set', obj: '_root', key: 'bird', value: 'jay', pred: ['1@111111'] }],
      }
      const remote1 = {
        actor: '222222',
        seq: 1,
        ...
        time: 0,
        deps: [],
        ops: [{ action: 'set', obj: '_root', key: 'fish', value: 'goldfish', pred: [] }],
      }
      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyLocalChange(v0, local1)
      const [v2, patch2] = Backend.applyChanges(v1, [encodeChange(remote1)])
      const [v3, patch3] = Backend.applyLocalChange(v2, local2)
      const changes = Backend.getAllChanges(v3).map(decodeChange)
      assert.deepStrictEqual(changes, [
        ...
        },
        {
          ...
          message: '',
          deps: [],
          ops: [{ action: 'set', obj: '_root', key: 'fish', insert: false, value: 'goldfish', pred: [] }],
        },
        {
          ...
          message: '',
          deps: [changes[0].hash],
          ops: [{ action: 'set', obj: '_root', key: 'bird', insert: false, value: 'jay', pred: ['1@111111'] }],
        },
      ])
    })
    ...
    it('should detect conflicts based on the frontend version', () => {
      const local1 = {
        ...
        startOp: 1,
        deps: [],
        ops: [{ action: 'set', obj: '_root', key: 'bird', value: 'goldfinch', pred: [] }],
      }
      ...
      const remote1 = {
        ...
        time: 0,
        deps: [],
        ops: [{ action: 'set', obj: '_root', key: 'bird', value: 'magpie', pred: ['1@111111'] }],
      }
      ...
      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyLocalChange(v0, local1)
      remote1.deps.push(Backend.getAllChanges(v1).map(decodeChange)[0].hash)
      const [v2, patch2] = Backend.applyChanges(v1, [encodeChange(remote1)])
      const [v3, patch3] = Backend.applyLocalChange(v2, local2)
      const changes = Backend.getAllChanges(v3).map(decodeChange)
      assert.deepStrictEqual(patch3, {
    ...
    it('should transform list indexes into element IDs', () => {
      const remote1 = {
        ...
        time: 0,
        deps: [],
        ops: [{ obj: '_root', action: 'makeList', key: 'birds', pred: [] }],
      }
      const remote2 = {
        actor: '222222',
        seq: 2,
        ...
        time: 0,
        deps: [hash(remote1)],
        ops: [{ obj: '1@222222', action: 'set', elemId: '_head', insert: true, value: 'magpie', pred: [] }],
      }
      const local1 = {
        actor: '111111',
        seq: 1,
        ...
        time: 0,
        deps: [hash(remote1)],
        ops: [{ obj: '1@222222', action: 'set', elemId: '_head', insert: true, value: 'goldfinch', pred: [] }],
      }
      const local2 = {
        actor: '111111',
        seq: 2,
        ...
        time: 0,
        deps: [],
        ops: [{ obj: '1@222222', action: 'set', elemId: '2@111111', insert: true, value: 'wagtail', pred: [] }],
      }
      const local3 = {
        actor: '111111',
        seq: 3,
      ...
      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyChanges(v0, [encodeChange(remote1)])
      const [v2, patch2] = Backend.applyLocalChange(v1, local1)
      const [v3, patch3] = Backend.applyChanges(v2, [encodeChange(remote2)])
      const [s4, patch4] = Backend.applyLocalChange(v3, local2)
      ...
      assert.deepStrictEqual(changes[4], {
        ...
        time: 0,
        message: '',
        deps: [hash(remote2), changes[3].hash].sort(),
        ops: [
    ...
    it('should handle list element insertion and deletion in the same change', () => {
      ...
      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyLocalChange(v0, local1)
      const [v2, patch2] = Backend.applyLocalChange(v1, local2)
      const changes = Backend.getAllChanges(v2).map(decodeChange)
      assert.deepStrictEqual(patch2, {
        actor: '111111',
        seq: 2,
        clock: { 111111: 2 },
      ...
      assert.deepStrictEqual(changes, [
        {
          ...
          message: '',
          deps: [],
          ops: [{ obj: '_root', action: 'makeList', key: 'birds', insert: false, pred: [] }],
        },
        {
    ...
    it('should compress changes with DEFLATE', () => {
      ...
      const change1 = {
        ...
        startOp: 1,
        deps: [],
        ops: [{ action: 'set', obj: '_root', key: 'longString', value: longString, pred: [] }],
      }
      const [v1, patch1] = Backend.applyLocalChange(Backend.init(), change1)
      const changes = Backend.getAllChanges(v1)
      const [v2, patch2] = Backend.applyChanges(Backend.init(), changes)
    ...
    it('should support inserting multiple elements in one change', () => {
      ...
      const v0 = Backend.init()
      const [v1, patch1] = Backend.applyLocalChange(v0, localChange)
      const changes = Backend.getChanges(v1, []).map(decodeChange)
      assert.deepStrictEqual(patch1, {
        clock: { [actor]: 1 },
        deps: [],
        maxOp: 6,
  ...
  describe('save() and load()', () => {
    it('should reconstruct changes that resolve conflicts', () => {
      ...
      const change3 = {
        ...
        startOp: 2,
        time: 0,
        deps: [hash(change1), hash(change2)],
        ops: [{ action: 'set', obj: '_root', key: 'bird', value: 'robin', pred: [`1@${actor1}`, `1@${actor2}`] }],
      }
      const v1 = Backend.loadChanges(Backend.init(), [change1, change2, change3].map(encodeChange))
      const v2 = Backend.load(Backend.save(v1))
      assert.deepStrictEqual(Backend.getHeads(v2), [hash(change3)])
    })
  ...
  describe('getPatch()', () => {
    it('should include the most recent value for a key', () => {
      ...
      const change2 = {
        ...
        time: 0,
        deps: [hash(change1)],
        ops: [{ action: 'set', obj: '_root', key: 'bird', value: 'blackbird', pred: [`1@${actor}`] }],
      }
      const v1 = Backend.loadChanges(Backend.init(), [change1, change2].map(encodeChange))
      assert.deepStrictEqual(Backend.getPatch(v1), {
        clock: { [actor]: 2 },
        deps: [hash(change2)],
        maxOp: 2,
        pendingChanges: 0,
    ...
    it('should handle counter increments at a key in a map', () => {
      ...
      const change1 = {
        ...
        time: 0,
        deps: [],
        ops: [{ action: 'set', obj: '_root', key: 'counter', value: 1, datatype: 'counter', pred: [] }],
      }
      const change2 = {
        actor,
        seq: 2,
        ...
        time: 0,
        deps: [hash(change1)],
        ops: [{ action: 'inc', obj: '_root', key: 'counter', value: 2, pred: [`1@${actor}`] }],
      }
      const v1 = Backend.loadChanges(Backend.init(), [change1, change2].map(encodeChange))
      assert.deepStrictEqual(Backend.getPatch(v1), {
        clock: { [actor]: 2 },
    ...
    it('should handle deletion of a counter', () => {
      ...
      const change3 = {
        ...
        time: 0,
        deps: [hash(change2)],
        ops: [{ action: 'del', obj: '_root', key: 'counter', pred: [`1@${actor}`] }],
      }
      const v1 = Backend.loadChanges(Backend.init(), [change1, change2, change3].map(encodeChange))
      assert.deepStrictEqual(Backend.getPatch(v1), {
        clock: { [actor]: 3 },
          ...
          props: {
            birds: {
              [`1@${actor}`]: {
                objectId: `1@${actor}`,
                type: 'map',
                props: { sparrows: { [`4@${actor}`]: { type: 'value', value: 15 } } },
              },
            },
          },
        },
    ...
    it('should create lists', () => {
      ...
      const v1 = Backend.loadChanges(Backend.init(), [encodeChange(change1)])
      assert.deepStrictEqual(Backend.getPatch(v1), {
        clock: { [actor]: 1 },
        deps: [hash(change1)],
        maxOp: 2,
    ...
    it('should handle conflicts on list elements', () => {
      ...
      const change2 = {
        ...
        time: 0,
        deps: [hash(change1)],
        ops: [{ action: 'set', obj: `1@${actor1}`, elemId: `2@${actor1}`, value: 'greenfinch', pred: [`2@${actor1}`] }],
      }
      const change3 = {
        actor: actor2,
        seq: 1,
        ...
        time: 0,
        deps: [hash(change1)],
        ops: [{ action: 'set', obj: `1@${actor1}`, elemId: `2@${actor1}`, value: 'goldfinch', pred: [`2@${actor1}`] }],
      }
      const v1 = Backend.loadChanges(Backend.init(), [change1, change2, change3].map(encodeChange))
      assert.deepStrictEqual(Backend.getPatch(v1), {
        clock: { [actor1]: 2, [actor2]: 1 },
    ...
    it('should handle nested maps in lists', () => {
      ...
      const v1 = Backend.loadChanges(Backend.init(), [encodeChange(change)])
      assert.deepStrictEqual(Backend.getPatch(v1), {
        clock: { [actor]: 1 },
        deps: [hash(change)],
        maxOp: 4,
    ...
    it('should condense multiple inserts into a single edit', () => {
      ...
      const v1 = Backend.loadChanges(Backend.init(), [change1].map(encodeChange))
      assert.deepStrictEqual(Backend.getPatch(v1), {
        clock: { [actor]: 1 },
        deps: [hash(change1)],
        maxOp: 5,
